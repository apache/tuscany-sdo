 ...
 */
 public class SDOFactoryClass
 {
  ...
  protected final String TEXT_102 = "();" + NL + "" + NL + "\t\t// Initialize dependent packages";
  protected final String TEXT_103 = NL + "\t\t";
  protected final String TEXT_104 = " ";
  protected final String TEXT_105 = "Instance = ";
  protected final String TEXT_106 = ".INSTANCE;";
  protected final String TEXT_107 = NL + "\t\t" + NL + "\t\t// Create package meta-data objects" + NL + "\t\tinstance.createMetaData();" + NL + "" + NL + "\t\t// Initialize created meta-data" + NL + "\t\tinstance.initializeMetaData();" + NL + "\t\t" + NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\t//the";
  protected final String TEXT_108 = ".freeze(); //FB do we need to freeze / should we freeze ????" + NL + "" + NL + "\t\treturn instance;" + NL + "\t}" + NL + "  " + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\tpublic void createMetaData()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_109 = "\t" + NL + "" + NL + "\t\t// Create types and their properties";
  protected final String TEXT_110 = NL + "\t\t";
  protected final String TEXT_111 = "Type = createType(false, ";
  protected final String TEXT_112 = ");";
  protected final String TEXT_113 = NL + "\t\tcreateProperty(";
  protected final String TEXT_114 = ", ";
  protected final String TEXT_115 = "Type,";
  protected final String TEXT_116 = ".INTERNAL_";
  protected final String TEXT_117 = "); ";
  protected final String TEXT_118 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_119 = NL + "\t\t";
  protected final String TEXT_120 = "Type = createType(true, ";
  protected final String TEXT_121 = " );";
  protected final String TEXT_122 = NL + "\t}" + NL + "\t" + NL + "\tprivate boolean isInitialized = false;" + NL + "" + NL + "\tpublic void initializeMetaData()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;";
  protected final String TEXT_123 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_124 = NL + "\t\t";
  protected final String TEXT_125 = " ";
  protected final String TEXT_126 = " = (";
  protected final String TEXT_127 = ")";
  protected final String TEXT_128 = ".INSTANCE;";
  protected final String TEXT_129 = NL + "\t\t";
  protected final String TEXT_130 = " property = null;" + NL + "" + NL + "\t\t// Add supertypes to types";
  protected final String TEXT_131 = NL + "\t\taddSuperType(";
  protected final String TEXT_132 = "Type, ";
  protected final String TEXT_133 = ".get";
  protected final String TEXT_134 = "());";
  protected final String TEXT_135 = NL + NL + "\t\t// Initialize types and properties";
  protected final String TEXT_136 = NL + "\t\tinitializeType(";
  protected final String TEXT_137 = "Type, ";
  protected final String TEXT_138 = ".class, \"";
  protected final String TEXT_139 = "\", ";
  protected final String TEXT_140 = ");";
  protected final String TEXT_141 = NL + "\t\tsetInstanceProperty (";
  protected final String TEXT_142 = "Type, \"";
  protected final String TEXT_143 = "\", ";
  protected final String TEXT_144 = ", ";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "\t\tproperty = getLocalProperty(";
  protected final String TEXT_147 = "Type, ";
  protected final String TEXT_148 = ");";
  protected final String TEXT_149 = NL + "\t\tinitializeProperty(property, ";
  ...
  protected final String TEXT_161 = NL + "\t\tinitializeProperty(property, ";
  ...
  protected final String TEXT_171 = NL + "\t\tsetInstanceProperty (property, \"";
  protected final String TEXT_172 = "\", ";
  protected final String TEXT_173 = ", ";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL;
  protected final String TEXT_176 = NL + "\t\t// Initialize data types";
  protected final String TEXT_177 = NL + "\t\tinitializeType(";
  protected final String TEXT_178 = "Type, ";
  protected final String TEXT_179 = ".class, \"";
  protected final String TEXT_180 = "\", ";
  protected final String TEXT_181 = ", ";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "\t\tsetInstanceProperty (";
  protected final String TEXT_184 = "Type, \"";
  protected final String TEXT_185 = "\", ";
  protected final String TEXT_186 = ", ";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = NL + "\t\tcreateXSDMetaData(";
  protected final String TEXT_190 = ");" + NL + "\t}" + NL + "\t  " + NL + "\tprotected void createXSDMetaData(";
  protected final String TEXT_191 = ")" + NL + "\t{" + NL + "\t\tsuper.initXSD();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_192 = " property = null;" + NL + "\t\t";
  ...
  protected final String TEXT_219 = NL + "\t\taddXSDMapping" + NL + "\t\t\t(getLocalProperty(";
